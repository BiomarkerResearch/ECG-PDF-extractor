...
# All ECG PDFs (brand-neutral input folder)
for name in os.listdir(os.path.join(BASE, 'data/original_ecgs/')):
    if name.endswith('.pdf'):
        inspect_pdf(os.path.join(BASE, 'data/original_ecgs/', name), name)
